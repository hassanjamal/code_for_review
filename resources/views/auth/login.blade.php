        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('tenant:login') }}">
                        @csrf
                        ...
                        {{-- <div class="flex flex-wrap mb-6">
                            ...
                            <input id="business_name" type="business_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline{{ $errors->has('business_name') ? ' border-red-500' : '' }}" name="business_name" value="{{ old('business_name') }}" required autofocus>
