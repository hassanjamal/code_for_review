...
class FormSentActionTest extends TestCase
{
    use RefreshDatabase;


    /** @test */
    public function it_logs_form_sent_activity()
    {
        $this->createTenant();
        ...
        $this->assertEquals('Form Sent', $activity->description);
    }
}
